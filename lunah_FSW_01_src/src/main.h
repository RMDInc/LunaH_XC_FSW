...
#else
int get_data(char * EVT_filename0, char * CNT_filename0, char * EVT_filename1, char * CNT_filename1, int i_neutron_total, char * RecvBuffer, XTime local_time_start, XTime local_time);						// Print data skipping saving it to SD card
#endif
